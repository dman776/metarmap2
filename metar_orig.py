...
# metar_orig.py script iteration 1.4.1
...
print("Running metar_orig.py at " + datetime.datetime.now().strftime('%d/%m/%Y %H:%M'))
...
# Read the airports.json file to retrieve list of airports.json and use as order for LEDs
